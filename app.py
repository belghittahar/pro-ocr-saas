...
/* Glassmorphism/Premium Dark Container with neon subtle glow */
.glass-container {
    ...
    padding: 2.5rem;
    box-shadow: 0 8px 32px 0 rgba(79, 139, 255, 0.1);
    margin-bottom: 2rem;
}
...
/* Neon Gradient Title */
.main-title {
    background: -webkit-linear-gradient(45deg, #4F8BFF, #7C3AED, #FF4F8B);
    ...
    text-shadow: 0px 0px 20px rgba(124, 58, 237, 0.4);
}
...
/* Universal Button Styling (Download Buttons & AI Actions) */
.stDownloadButton > button, div[data-testid="stButton"] > button {
    background: linear-gradient(135deg, #4F8BFF 0%, #7C3AED 100%) !important;
    color: #FAFAFA !important;
...
.stDownloadButton > button:hover, div[data-testid="stButton"] > button:hover {
    transform: translateY(-2px) !important;
    box-shadow: 0 6px 20px rgba(124, 58, 237, 0.6) !important;
    filter: brightness(1.1);
}

/* High-Contrast File Uploader Customization */
[data-testid="stFileUploadDropzone"] {
    background-color: #1A1F29 !important;
    border: 2px dashed #4F8BFF !important;
...
[data-testid="stFileUploadDropzone"]:hover {
    ...
    box-shadow: inset 0 0 20px rgba(79, 139, 255, 0.1) !important;
}
/* Specifically target the 'Browse files' button inside the dropzone to be bright */
...
.stTextArea textarea:focus {
    ...
    box-shadow: 0 0 0 2px rgba(79, 139, 255, 0.5) !important;
}
...
def render_audio_to_text():
    st.markdown('<p class="main-title">🎙️ Audio to Text</p>', unsafe_allow_html=True)
...
def main():
    ...
    with st.sidebar:
        ...
        page = option_menu(
            ...
            icons=["magic", "file-earmark-code", "mic-fill", "shield-lock", "file-earmark-check", "envelope"],
            menu_icon="cast",
            default_index=0,
            styles={
